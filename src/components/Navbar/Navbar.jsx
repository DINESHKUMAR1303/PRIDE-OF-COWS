    ...
    <>
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        <ul className="mobile-links">
          ...
          <li>
            <img src={enquiryIcon} alt="enquiry" className="right-icon" /> Enquiry
          </li>
          <li>
            <img src={helpIcon} alt="help" className="right-icon" /> Help
          </li>
          <li>
            <img src={contactIcon} alt="contact" className="right-icon" /> Contact
          </li>
          <li>
            <img src={faqIcon} alt="faq" className="right-icon" /> FAQ
          </li>

          <li className="section-title">Learn More</li>
          <li>
            <img src={aboutIcon} alt="about" className="right-icon" /> About Us
          </li>
          <li>
            <img src={lifestyleIcon} alt="lifestyle" className="right-icon" /> Life Style
          </li>
          <li>
            <img src={recipesIcon} alt="recipes" className="right-icon" /> Recipes
          </li>
        </ul>
