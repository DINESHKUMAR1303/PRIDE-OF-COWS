...
const products = [
  { id: 1, name: "Milk", mrp: "₹120", size: "1L", image: milk },
  { id: 2, name: "Fat Free Milk", mrp: "₹130", size: "1L", image: fatfree },
  { id: 3, name: "Ghee", mrp: "₹1890", size: "1L", image: ghee },
  { id: 4, name: "Curd", mrp: "₹80", size: "500g", image: curd },
  { id: 5, name: "Paneer", mrp: "₹160", size: "200g", image: paneer },
  { id: 6, name: "Milk Powder", mrp: "₹350", size: "500g", image: milkpowder },
  { id: 7, name: "LowFat Paneer", mrp: "₹235", size: "200gm", image: highproteinpaneer },
  { id: 8, name: "Wafer Bar", mrp: "₹80", size: "40gm", image: waferbar },
];
          ...
          {products.map((item) => {
            ...
            return (
              <div
                ...
                key={item.id}
                onClick={() => {
                  if (item.id === 1) navigate("/shop/milk"); // ⭐ Only Milk goes to page
                }}
