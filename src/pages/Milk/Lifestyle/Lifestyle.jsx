...
const cards = [
  ...
  {
    img: img2,
    text: "Savour the essence: Pride of cows redefines luxury with pure, single-origin milk",
  },
  {
    img: img3,
  ...
  {
    img: img4,
    text: "Discover the pure taste of single-origin milk: A journey to the source",
  },
  {
    img: img5,
    text: "FSSAI debunks the A2 vs A1 myths — purity wins over gimmicks!",
  },
];
...
const Lifestyle = () => {
  ...
  return (
    <section className="lifestyle-outer">
      <h2 className="lifestyle-title">Health Is A Lifestyle</h2>

      {/* Slider Wrapper */}
      <div className="lifestyle-cards-wrapper" {...handlers}>
        <div
          className="lifestyle-cards-inner"
          style={{
